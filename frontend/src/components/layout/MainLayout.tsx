      ...
      <div className="flex h-[calc(100vh-4rem)]">
        <aside className="w-64 bg-white border-r">
          <nav className="mt-5 px-2">
            ...
            <Link
              to="/accounts"
              className={`group flex items-center px-2 py-2 text-sm font-medium rounded-md ${isActive('/accounts')
                  ? 'text-gray-900 bg-gray-100'
                  : 'text-gray-600 hover:bg-gray-50 hover:text-gray-900'
                }`}
            >
            ...
            <Link
              to="/transactions"
              className={`group flex items-center px-2 py-2 text-sm font-medium rounded-md ${isActive('/transactions')
                  ? 'text-gray-900 bg-gray-100'
                  : 'text-gray-600 hover:bg-gray-50 hover:text-gray-900'
                }`}
            >
